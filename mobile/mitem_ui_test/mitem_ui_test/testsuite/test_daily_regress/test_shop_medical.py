...
class TestShopMedical(BasePage):
    ...
    @pytest.mark.p1
    def test_single_break(self, first_page_wait):
        first_page_wait.close_auto_list()
        shop_test_page = first_page_wait.go_shop_test_top_area()
    ...
    @pytest.mark.p1
    def test_one_touch_optimize(self, first_page_wait):
        shop_test_page = first_page_wait.go_shop_test_top_area()
