...
class TestDetailPage(BasePage):
    ...
    @pytest.mark.p1
    def test_edit_title(self, go_detail_page_onsale_title):
        """
        1.进入详情页
        2.编辑标题
        3.判断页面时显示的标题是否一致
        4.还原标题
        """
        detail_page = go_detail_page_onsale_title
        new_title = '编辑后的标题'
    ...
    @pytest.mark.p2
    def test_title_improve(self, go_detail_page_onsale_title):
        """
         1.进入详情页
         2.点击标题检测图片，进入标题优化页
         3.一键优化标题并更新到淘宝
         4.返回详情页，还原标题
         5.判断标题是否实际更新
        :param go_detail_page_onsale_title:
        :return:
        """
        detail_page = go_detail_page_onsale_title
    ...
    @pytest.mark.p2
    def test_edit_pic(self, go_detail_page_onsale):
        """
        1.进入详情页
        2.进入编辑图片页面
        3.删除所有图片
        ...
        :return:
        """
        detail_page = go_detail_page_onsale
    ...
    @pytest.mark.p2
    def test_create_short_video(self, go_detail_page_onsale):
        """
            1.进入详情页
            2.提交任务
            3.判断任务是否提交成功
    ...
    @pytest.mark.p1
    def test_list_delist(self, go_detail_page_onsale):
        """
        1.进入详情页,切换基本信息tab
    ...
    @pytest.mark.p2
    def test_soldout_status(self, go_detail_page_soldout):
        """
        1.进入详情页,切换基本信息tab
        2.判断宝贝状态一栏，显示的按钮是否为"已售完"
        3.判断点击按钮没有反应
        :param go_detail_page_soldout:
        :return:
        """
        detail_page = go_detail_page_soldout
        detail_page.switch_tab(1)
        flag = True
        try:
    ...
    @pytest.mark.p2
    def test_edit_code(self, go_detail_page_onsale):
        """
        1.进入详情页
        2.切换基本信息tab
        3.编辑商家编码
    ...
    @pytest.mark.p2
    def test_edit_props_1(self, go_detail_page_onsale):
        """
        1.进入详情页
        2.切换基本信息tab
        3.进入属性页面
    ...
    def test_edit_props_2(self, go_detail_page_format_props):
        """
        1.进入详情页
        2.切换基本信息tab
        3.进入属性页面
        ...
        6.点击保存返回
        7.再次进入属性页面，判断编辑是否生效
        :param go_detail_page_format_props:
        :return:
        """
        detail_page = go_detail_page_format_props
        detail_page.switch_tab(1)
        props_page = detail_page.go_item_property_page()
    ...
    @pytest.mark.p2
    def test_edit_shop_cat(self, go_detail_page_onsale):
        """
        1.进入详情页
        2.切换基本信息tab
        3.点击店铺分类，清空所有选中项，保存
    ...
    @pytest.mark.p2
    def test_edit_delivery(self, go_detail_page_onsale):
        """
        1.进入详情页
        2.切换基本信息tab
        3.点击运费模板，选择国内模板
    ...
    @pytest.mark.p2
    def test_edit_other_info(self, go_detail_page_onsale):
        """
        1.进入详情页
        2.切换基本信息tab
        3.编辑其他信息
    ...
    @pytest.mark.p1
    def test_submit_mdetail_task(self, go_detail_page_inventory):
        """
        1.进入详情页
        2.切换手机详情tab
        3.提交任务
        4.判断任务是否提交成功
        :param go_detail_page_inventory:
        :return:
        """
        detail_page = go_detail_page_inventory
    ...
    @pytest.mark.p2
    def test_onsale_buttom_button(self, go_detail_page_onsale):
        """
        1.进入出售中sku宝贝的详情页
    ...
    @pytest.mark.p2
    def test_inventory_buttom_button(self, go_detail_page_inventory):
        """
        1.进入仓库中无sku宝贝的详情页
        2.判断主图/视频tab下的按钮显示正常
        3.判断按钮可以正常点击
    ...
    @pytest.mark.p1
    def test_activity_calendar(self, go_detail_page_inventory):
        assert go_detail_page_inventory.activity_calendar_shop_test_enter()

    @allure.feature('详情页')
    @allure.story('详情页，添加、删除水印')
    @pytest.mark.p1
    @pytest.mark.skip(reason='bug：促销水印，第一个热门水印无法正常跳转')
    def test_add_delete_watermark(self, go_detail_page_onsale):
        assert go_detail_page_onsale.add_delete_watermark(), '水印任务没有成功发起，或者任务耗时异常，请检查后端水印队列'

    @allure.feature('详情页')
    @allure.story('详情页，有sku宝贝，sku价格库存可以正常编辑')
    @pytest.mark.p1
    def test_edit_sku(self, go_detail_page_onsale):
        """
        1.进入详情页
        2.切换销售规格tab
        3.编辑sku
    ...
    @pytest.mark.p2
    def test_edit_fixed_price_with_sku(self, go_detail_page_onsale):
        """
        1.进入详情页
        2.切换销售规格tab
        3.获取第一个sku的价格
    ...
    @pytest.mark.p1
    def test_edit_fixed_price_without_sku(self, go_detail_page_inventory):
        """
        1.进入详情页
        2.切换销售规格tab
        3.编辑一口价、库存
    ...
    @pytest.mark.p1
    def test_edit_mdetail(self, go_detail_page_onsale):
        """
        1.进入出售中中宝贝详情页
        2.切换手机详情tab
        3.进入编辑模式
