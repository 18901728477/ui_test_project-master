...
class TestAutoEvaluate:
    ...
    # def test_delete_latest_nick(self, auto_evaluate_by_scan):
    #     """
    #     1.进入自动评价页面
    #     2.点击黑名单管理，进入黑名单页面
    #     3.新增一个用户，然后立刻删除
    ...
    # def test_edit_phrase(self, auto_evaluate_by_scan):
    #     """
    #     1.进入自动评价页面
    #     2.点击评价短语，进入评价短语页面
    #     3.编辑一条短语
    ...
    # def test_delete_phrase(self, auto_evaluate_by_scan):
    #     """
    #     1.进入自动评价页面
    #     2.点击评价短语，进入评价短语页面
    #     3.删除一条短语
    ...
    # def test_api_get_latest_success_record(self, auto_evaluate_by_scan):
    #     """
    #       1.进入自动评价页面
    #       2.点击评价记录，进入评价记录页面
    #       3.进入成功记录tab
    #       4.校验最新一条记录
    #     :param auto_evaluate_by_scan:
    #     :return:
    #     """
    #     auto_evaluate_page = auto_evaluate_by_scan
    ...
    # def test_api_get_latest_fail_record(self, auto_evaluate_by_scan):
    #     """
    #       1.进入自动评价页面
    #       2.点击评价记录，进入评价记录页面
    #       3.进入失败记录tab
    ...
    # def test_go_order_detail(self, auto_evaluate_by_scan):
    #     """
    #       1.进入自动评价页面
    #       2.点击评价记录，进入评价记录页面
    #       3.点击记录进入订单详情页
    ...
    # def test_change_evaluate_methods(self, auto_evaluate_by_scan):
    #     """
    #      1.进入自动评价页面
    ...
    # @pytest.mark.skip(reason="避免影响其他调试工作")
    # def test_four_evaluate_methods(self, auto_evaluate_by_scan):
    #     """
    #      1.进入自动评价页面
    #      2.关闭四个子开关
    #      3.返回首页，再次进入自动评价页面
    ...
    # @pytest.mark.skip(reason="避免影响其他调试工作")
    # def test_turn_main_switch(self, auto_evaluate_by_scan):
    #     """
    #      1.进入自动评价页面
    #      2.切换总开关
    #      3.判断总开关状态是否变化
