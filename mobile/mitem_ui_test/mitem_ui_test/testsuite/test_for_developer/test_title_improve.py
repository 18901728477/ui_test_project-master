...
class TestTitleImprove(BasePage):
    ...
    @pytest.mark.p2
    def test_check_update_time(self, go_title_improve_list_scan):
        """
        1.进入标题优化列表页
        2.重新检测，判断上次检测时间是否同步
        3.筛选分类、搜索宝贝
        ...
        :return:
        """
        title_improve_list_page = go_title_improve_list_scan
    ...
    @pytest.mark.p2
    def test_amout_item(self, go_firstpage_scan):
        """
    ...
    @pytest.mark.p2
    def test_title_result(self, go_title_improve_detail_scan):
        """
        1.进入标题优化，优化详情页
        ...
        title_improve_detail_page = go_title_improve_detail_scan
    ...
    @pytest.mark.p2
    def test_result_detail(self, go_title_improve_detail_scan):
        """
        1.进入标题优化，优化详情页
    ...
    @pytest.mark.p1
    def test_add_one_word_from_table(self, go_title_improve_detail_scan):
        """
          1.进入标题优化，优化详情页
    ...
    @pytest.mark.p1
    def test_one_click_improve(self, go_title_improve_detail_scan):
        """
         1.进入标题优化，优化详情页
         2.一键优化标题
         3.点击更新到淘宝，还原标题
