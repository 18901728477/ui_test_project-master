...
class TestMedetail(BasePage):
    ...
    @pytest.mark.p2
    def test_mdetail_get_item_num(self, go_mdetail):
        """
        1.进入手机详情首页
    ...
    @pytest.mark.p1
    def test_mdetail_full_shop_submit_with_filter(self,go_mdetail):
        """
    ...
    @pytest.mark.p1
    def test_mdetail_full_shop_submit_without_filter(self,go_mdetail):
        """
        1.进入手机详情首页
        2.宝贝范围切换至仓库中
        3.关闭过滤开关
    ...
    @pytest.mark.p2
    def test_mdetail_full_shop_submit_restart(self, go_mdetail):
        """
        1.进入手机详情首页
        2.关闭过滤开关，提交全店任务
        3.终止任务
    ...
    @pytest.mark.p1
    def test_mdetail_batch_create(self, go_mdetail):
        """
        1.进入手机详情首页
        2.进入列表页
    ...
    @pytest.mark.p2
    def test_mdetail_single_create(self, go_mdetail):
        """
        1.进入手机详情首页
        2.切换仓库中
        3.进入列表页
    ...
    @pytest.mark.p2
    def test_mdetail_fail_reason(self, go_mdetail):
        """
         1.进入手机详情首页
         2.进入列表页
         3.搜索关键词“保温杯”
